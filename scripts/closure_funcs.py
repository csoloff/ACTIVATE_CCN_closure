...
def S_func(D, D_d, k):
    ...
    :return: Saturation
    '''
    A = 4*0.0712*0.0180153/(8.3144598*(273.15+30)*1000)#0.000000002128678 # constant 4*0.072*0.0180153/(8.3144598*273.15*1000) # 2.1e-09 # 2.28454e-09
...
def find_k(s, D_d):
    ...
    result = root_scalar(find_ss_diff, bracket=[.001, 3.0])
